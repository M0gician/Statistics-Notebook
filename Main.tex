...
\newtheorem{exerciseT}{Definition}[chapter]
\theoremstyle{blacknumexa}
\newtheorem{exampleT}{Definition}[chapter]
...
{\begin{tikzpicture}[remember picture,overlay]
	...
	\draw[anchor=north] (midpoint) node [fill=ocre!80!white,fill opacity=1,text opacity=1,inner sep=1cm]{\Huge\centering\bfseries\sffamily\parbox[c][][t]{\paperwidth}{\centering \cDarkGrey{Statistics Notebook}\\[15pt] % Book title
			{\cDarkGrey{\huge by Tommy Yang }}\\[20pt] % Subtitle
...
\part{Chapter 2: Modeling Distributions of Data}
\subfile{Chapter2}

\part{Chapter 3: Describing Relationships}
\subfile{Chapter3}

\part{Chapter 4: Designing Studies}
\subfile{Chapter4}

\part{Chapter 5: Probability}
\subfile{Chapter5}

\part{Chapter 6: Random Variables}
\subfile{Chapter6}

%\part{Chapter 7: Sampling Distributions}
